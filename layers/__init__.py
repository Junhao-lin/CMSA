...
from layers.loss.pair_loss import CosineSimilarityLoss

__all__ = ['CenterLoss', 'CenterTripletLoss', 'AMSoftmaxLoss', 'TripletLoss', 'NormalizeLinear', 'js_div', 'cbam', 'NonLocalBlockND', 'CosineSimilarityLoss']